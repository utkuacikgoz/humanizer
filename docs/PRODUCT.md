...
Internal codename: `humanizer`. Brand name: Ownword, at ownword.pro, operated by Bosphorus Elevate LLC. The codename stays as the repository/package name; the brand is served from `src/config/product.ts`.
